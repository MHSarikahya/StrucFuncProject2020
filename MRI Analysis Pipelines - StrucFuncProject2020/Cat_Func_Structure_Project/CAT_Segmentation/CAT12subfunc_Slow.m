...
jobs  = 4;    %  a job will use min 4 cores for i.e. denoising
cores  = 4;   %  1 if multiple subjects are processed - but for FD not needed otherwise
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 %       % Save Figure
 %       figure_fn = ['m0wp1' num2str(cnt) '.jpg'];
 %       figure_fn_all = fullfile(targetdir,figure_fn);
 %       saveas(fig,figure_fn_all);
 %       close(fig);
...
%%%%%%%%%%%%%%%%%%%%%%
%%%%GRAB FIGURE%%%%%%%    WORKS but turned off for later parts of code
%%%%%%%%%%%%%%%%%%%%%%
%fig=gcf
%figure_fn = ['QC_' xsub '.fig'];
