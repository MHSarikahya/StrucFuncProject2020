function CAT12subfunc(sub_raw, xsub, targetdir, reproc)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
jobs  = 0;    %  a job will use min 4 cores for i.e. denoising; default is 0
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
def = fullfile(spm_file(which('CAT12subfunc'), 'path'), 'CatSeg'); %fix
try global spmx; if cat.extopts.expertgui == 1; spm fmri; cat12(def); end
