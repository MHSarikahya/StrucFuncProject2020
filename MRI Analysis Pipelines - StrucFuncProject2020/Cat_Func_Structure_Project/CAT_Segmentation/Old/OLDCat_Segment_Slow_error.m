...
cat.extopts.NCstr        = 4;       % Strength of the noise correction:          0 to 1; 0 - no filter, -Inf - auto, 1 - full, 2 - ISARNLM (else SANLM), default -Inf
...
cat.extopts.APP          = 2;  % #Edit: dont change?; but 0 - none; 1070 - default; 1 - light; 2 - full; 3 - strong; 4 - heavy
