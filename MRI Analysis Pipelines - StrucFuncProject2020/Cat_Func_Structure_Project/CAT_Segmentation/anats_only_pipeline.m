...
target = fullfile('/Users/Mohammed/Documents/StructureFunction/', sample); %output
...
for sub = 1:numel(xsubs)
    fprintf('Sent to unzipT1w_only, subject %s \n', xsubs{sub});
    unzipT1w_only(sub_raw{sub}(:,:), xsubs{sub}(:,:), targetdir{sub}(:,:), reproc);
end
