...
##########################################################
############## WRITE SESSION DATE TO SUMMARY DATA ########
##########################################################


### NOTE : SUBJECT 33 HAS TWO ARITHMETIC RUN 1 ON DIFFERENT SESSION DATES

# Session Date per run
a1 <- aggregate(arithmetic_run1$SessionDate, by= list(arithmetic_run1$Subject, arithmetic_run1$SessionDate), unique, na.rm=TRUE)
a1 <- a1[, 1:2]
names(a1) <- c("Subject", "SessionDate_arithmetic_run1")
arithmetic_run1_summary <- merge(arithmetic_run1_summary, a1)

a2 <- aggregate(arithmetic_run2$SessionDate, by= list(arithmetic_run2$Subject, arithmetic_run2$SessionDate), unique, na.rm=TRUE)
a2 <- a2[, 1:2]
names(a2) <- c("Subject", "SessionDate_arithmetic_run2")
...
# Session Date per run
a1 <- aggregate(arithmetic_run1$SessionTime, by= list(arithmetic_run1$Subject, arithmetic_run1$SessionTime), unique, na.rm=TRUE)
a1 <- a1[, 1:2]
names(a1) <- c("Subject", "SessionTime_arithmetic_run1")
arithmetic_run1_summary <- merge(arithmetic_run1_summary, a1)

a2 <- aggregate(arithmetic_run2$SessionTime, by= list(arithmetic_run2$Subject, arithmetic_run2$SessionTime), unique, na.rm=TRUE)
a2 <- a2[, 1:2]
names(a2) <- c("Subject", "SessionTime_arithmetic_run2")
arithmetic_run2_summary <- merge(arithmetic_run2_summary, a2)

b <- aggregate(vswm_r$SessionTime, by= list(vswm_r$Subject), unique, na.rm=TRUE)
names(b) <- c("Subject", "SessionTime_vswm")
vswm_summary <- merge(vswm_summary, b)

c <- aggregate(matching_r$SessionTime, by= list(matching_r$Subject), unique, na.rm=TRUE)
names(c) <- c("Subject", "SessionTime_matching")
matching_summary <- merge(matching_summary, c)
...
names(a1) <- c("Subject", "Session", "SessionDate_arithmetic_run1", "arithmetic_run1_acc_mean")
arithmetic_run1_summary <- merge(arithmetic_run1_summary, a1)
...
names(a2) <- c("Subject", "Session", "SessionDate_arithmetic_run2", "arithmetic_run2_acc_mean")
arithmetic_run2_summary <- merge(arithmetic_run2_summary, a2)
...
names(a1) <- c("Subject", "Session", "SessionDate_arithmetic_run1", "arithmetic_run1_RT_mean")
arithmetic_1_summary <- merge(arithmetic_run1_summary, a1)
...
names(a2) <- c("Subject", "Session", "SessionDate_arithmetic_run2", "arithmetic_run2_RT_mean")
arithmetic_2_summary <- merge(arithmetic_run2_summary, a2)
