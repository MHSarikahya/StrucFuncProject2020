...
#write.csv(arithmetic_r, file = "arithmetic_long_06_18_20.csv", row.names=FALSE)
#write.csv(vswm_r, file = "vswm_long_06_18_20.csv", row.names=FALSE)
#write.csv(matching_r, file = "matching_long_06_18_20.csv", row.names=FALSE)
...
write.csv(arithmetic_run1_summary, file = "arithmetic_run1_summary_06_30_20.csv", row.names=FALSE)
write.csv(arithmetic_run2_summary, file = "arithmetic_run2_summary_06_30_20.csv", row.names=FALSE)
write.csv(arithmetic_all_summary, file = "arithmetic_all_summary_06_30_20.csv", row.names=FALSE)

write.csv(vswm_summary, file = "vswm_summary_06_30_20.csv", row.names=FALSE)

write.csv(matching_summary, file = "matching_summary_06_30_20.csv", row.names=FALSE)

## CHANGE THE VARIABLE NAMES ON THE LEFT WITH THE DATA AND THE VARIABLE ON THE RIGHT AS WELL

# ### MERGE ALL SUMMARY DATA
SF_MRI_task_behaviors_06_30_20 <- merge(arithmetic_run1_summary, arithmetic_run2_summary, all = TRUE)

SF_MRI_task_behaviors_06_30_20 <- merge(SF_MRI_task_behaviors_06_30_20, arithmetic_all_summary, all = TRUE)

SF_MRI_task_behaviors_06_30_20 <- merge(SF_MRI_task_behaviors_06_30_20 , vswm_summary, all = TRUE)

SF_MRI_task_behaviors_06_30_20  <- merge(SF_MRI_task_behaviors_06_30_20 , matching_summary, all = TRUE)

# ## CHANGE THE NAME OF YOUR FINAL DATA OUTPUT FILE
write.csv(SF_MRI_task_behaviors_06_30_20 , file = "SF_MRI_task_behaviors_06_30_20.csv", row.names=FALSE)
